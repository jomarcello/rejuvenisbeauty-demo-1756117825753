...
export const practiceTemplates: Record<string, PracticeConfig> = {
  'rejuvenisbeauty': {
    id: 'rejuvenisbeauty',
    name: 'Rejuvenisbeauty Clinic',
    doctor: 'Rejuvenisbeauty Clinic Team',
...
export function getCurrentPractice(): PracticeConfig {
  ...
  return practiceTemplates['rejuvenisbeauty'];
}